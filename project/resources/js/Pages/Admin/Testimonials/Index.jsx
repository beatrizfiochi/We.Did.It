...
export default function Index({ testimonials, categories }) {
    ...
    // what is shown in the table is according to the filtered Testimonials ( BY Status)
    ...
    const handleViewTestimonials = (row) => {
        setSelectedTestimonials(row);
    ...
    return (
        ...
        <AuthenticatedLayout header="Testemunhos">
            ...
            {/* Modal for viewing each individual testimonial */}
                ...
                {selectedTestimonials && (
                    <div className="p-6">
                        ...
                        <p className="text-sm text-gray-500 mb-2">
                            <strong>Nome:</strong> {selectedTestimonials.name}
                        </p>
                        <p className="text-sm text-gray-500 mb-2">
                            <strong>Email:</strong> {selectedTestimonials.email}
                        </p>

                        <p className="text-sm text-gray-500 mb-2">
                            <strong>Categoria:</strong> {selectedTestimonials.category?.name ?? "N/a"}
                        </p>

                        <p className="text-sm text-gray-500 mb-4">
                            <strong>Estado:</strong> {selectedTestimonials.status}
                        </p>

                        <p className="text-gray-700">
                            {selectedTestimonials.description}
                        </p>
                        ...
                        <div className="mt-6 flex flex-wrap justify-end gap-3">
                            <button
                                ...
                                onClick={() => {
                                    handleEditClick(selectedTestimonials);
                                    closeViewModal();
                                }}
                            >
                                Editar
                    ...
                    <div className="p-6">
                        ...
                        <div className="mb-3">
                            ...
                            <input
                                ...
                                value={editingTestimonials.title}
                                onChange={(e) =>
                                    setEditingTestimonials({ ...editingTestimonials, title: e.target.value })
                                }
                            />
                        ...
                        <div className="mb-3">
                            ...
                            <input
                                ...
                                value={editingTestimonials.name}
                                disabled
                            />
                        ...
                        <div className="mb-3">
                            ...
                            <input
                                type="text"
                                className="mt-1 block w-full rounded-md border-gray-300 bg-gray-100 shadow-sm"
                                value={editingTestimonials.email}
                                disabled
                            />
                        ...
                        <div className="mb-3">
                            ...
                            <textarea
                                ...
                                rows={4}
                                value={editingTestimonials.description}
                                onChange={(e) =>
                                    setEditingTestimonials({ ...editingTestimonials, description: e.target.value })
                                }
                            />
                        ...
                        <div className="mb-3">
                            ...
                            <select
                                ...
                                value={editingTestimonials.category_id ?? ""}
                                onChange={(e) =>
                                    setEditingTestimonials({ ...editingTestimonials, category_id: e.target.value || null })
                                }
                            >
